 ...
 */
export type KnownHookType = "on-run-start" | "on-run-complete" | "on-run-fail" | "on-task-start" | "on-task-complete" | "on-step-dispatch" | "on-iteration-start" | "on-iteration-end" | "on-breakpoint" | "pre-commit" | "pre-branch" | "post-planning" | "on-score";
