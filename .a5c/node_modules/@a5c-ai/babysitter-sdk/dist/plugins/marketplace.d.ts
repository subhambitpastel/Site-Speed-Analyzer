 ...
 */
import { MarketplaceManifest, MarketplacePluginEntry, PluginScope } from "./types";
/**
 ...
 */
export declare function deriveMarketplaceName(url: string): string;
/**
 ...
 */
export declare function cloneMarketplace(url: string, scope: PluginScope, projectDir?: string, manifestPath?: string, branch?: string, force?: boolean): Promise<string>;
/**
 ...
 */
export declare function updateMarketplace(marketplaceName: string, scope: PluginScope, projectDir?: string, branch?: string): Promise<void>;
/**
 ...
 * @param projectDir - Required when scope is 'project'
 */
export declare function readMarketplaceManifest(marketplaceName: string, scope: PluginScope, projectDir?: string): Promise<MarketplaceManifest>;
/**
 ...
 * @param projectDir - Required when scope is 'project'
 */
export declare function listMarketplacePlugins(marketplaceName: string, scope: PluginScope, projectDir?: string): Promise<MarketplacePluginEntry[]>;
/**
 ...
 * @param projectDir - Required when scope is 'project'
 */
export declare function resolvePluginPackagePath(marketplaceName: string, pluginName: string, scope: PluginScope, projectDir?: string): Promise<string>;
/**
 ...
 */
export declare function listMarketplaces(scope: PluginScope, projectDir?: string): Promise<string[]>;
