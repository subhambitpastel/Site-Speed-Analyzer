 ...
 */
export declare function getRegistryPath(scope: PluginScope, projectDir?: string): string;
/**
 ...
 * @param projectDir - Required when scope is 'project'
 */
export declare function getMarketplacesDir(scope: PluginScope, projectDir?: string): string;
/**
 ...
 * @param projectDir - Required when scope is 'project'
 */
export declare function getMarketplaceDir(marketplaceName: string, scope: PluginScope, projectDir?: string): string;
