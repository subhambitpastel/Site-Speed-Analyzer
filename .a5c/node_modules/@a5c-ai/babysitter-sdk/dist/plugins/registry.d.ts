 ...
 */
import { PluginRegistry, PluginRegistryEntry, PluginScope } from "./types";
/**
 ...
 */
export declare function readPluginRegistry(scope: PluginScope, projectDir?: string): Promise<PluginRegistry>;
/**
 ...
 * @param projectDir - Required when scope is 'project'
 */
export declare function writePluginRegistry(registry: PluginRegistry, scope: PluginScope, projectDir?: string): Promise<void>;
/**
 ...
 */
export declare function getPluginEntry(registry: PluginRegistry, pluginName: string): PluginRegistryEntry | undefined;
/**
 ...
 */
export declare function upsertPluginEntry(registry: PluginRegistry, entry: PluginRegistryEntry): PluginRegistry;
/**
 ...
 */
export declare function removePluginEntry(registry: PluginRegistry, pluginName: string): PluginRegistry;
/**
 * Returns all plugin entries as a sorted array (sorted by name).
 *
 * @param registry - The registry to list
 */
export declare function listPluginEntries(registry: PluginRegistry): PluginRegistryEntry[];
