 ...
 */
export declare const PLUGIN_REGISTRY_SCHEMA_VERSION = "2026.01.plugin-registry-v1";
/**
 * Filename for the JSON-serialized plugin registry.
 */
export declare const PLUGIN_REGISTRY_FILENAME = "plugin-registry.json";
/**
 * Filename for the marketplace manifest within a cloned marketplace directory.
 */
export declare const MARKETPLACE_MANIFEST_FILENAME = "marketplace.json";
/**
 ...
 */
export declare const MANIFEST_PATH_FILENAME = ".babysitter-manifest-path";
/**
