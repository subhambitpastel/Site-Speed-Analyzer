 ...
 */
import { MigrationDescriptor } from "./types";
/**
 ...
 */
export declare function parseMigrationFilename(filename: string): MigrationDescriptor | undefined;
/**
 ...
 */
export declare function listMigrations(migrationsDir: string): Promise<MigrationDescriptor[]>;
/**
 ...
 */
export declare function buildMigrationGraph(migrations: MigrationDescriptor[]): Map<string, MigrationDescriptor[]>;
/**
 ...
 */
export declare function findMigrationPath(migrations: MigrationDescriptor[], fromVersion: string, toVersion: string): MigrationDescriptor[] | undefined;
/**
 ...
 */
export declare function resolveMigrationChain(packageDir: string, fromVersion: string, toVersion: string): Promise<Array<{
