 ...
 */
import { MigrationDescriptor, PluginPackageInfo } from "./types";
/**
 ...
 */
export declare function readPluginPackage(packageDir: string): Promise<PluginPackageInfo>;
/**
 * Reads the install instructions markdown file from a plugin package.
 *
 * @param packageDir - Absolute path to the plugin package directory
 */
export declare function readInstallInstructions(packageDir: string): Promise<string | undefined>;
/**
 * Reads the uninstall instructions markdown file from a plugin package.
 *
 * @param packageDir - Absolute path to the plugin package directory
 */
export declare function readUninstallInstructions(packageDir: string): Promise<string | undefined>;
/**
 * Reads the configure instructions markdown file from a plugin package.
 *
 * @param packageDir - Absolute path to the plugin package directory
 */
export declare function readConfigureInstructions(packageDir: string): Promise<string | undefined>;
/**
 ...
 * @param packageDir - Absolute path to the plugin package directory
 */
export declare function listMigrations(packageDir: string): Promise<MigrationDescriptor[]>;
/**
 ...
 */
export declare function readMigration(packageDir: string, from: string, to: string): Promise<string>;
//# sourceMappingURL=packageReader.d.ts.map