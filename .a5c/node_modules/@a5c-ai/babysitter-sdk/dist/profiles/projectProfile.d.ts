 ...
 */
export declare function getProjectProfileDir(projectRoot?: string): string;
/**
 ...
 */
export declare function readProjectProfile(projectRoot?: string): ProjectProfile | null;
/**
 ...
 * @param projectRoot - Absolute path to the project root. Defaults to `process.cwd()`.
 */
export declare function writeProjectProfile(profile: ProjectProfile, projectRoot?: string): void;
/**
 ...
 */
export declare function mergeProjectProfile(existing: ProjectProfile, updates: Partial<ProjectProfile>): ProjectProfile;
/**
 ...
 */
export declare function createDefaultProjectProfile(projectName: string): ProjectProfile;
/**
 ...
 */
export declare function renderProjectProfileMarkdown(profile: ProjectProfile): string;
