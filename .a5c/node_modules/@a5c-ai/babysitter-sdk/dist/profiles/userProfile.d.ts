 ...
 */
export declare function getUserProfileDir(): string;
/**
 ...
 */
export declare function readUserProfile(profileDir?: string): UserProfile | null;
/**
 ...
 */
export declare function writeUserProfile(profile: UserProfile, profileDir?: string): void;
/**
 ...
 */
export declare function mergeUserProfile(existing: UserProfile, updates: Partial<UserProfile>): UserProfile;
/**
 ...
 */
export declare function createDefaultUserProfile(name: string): UserProfile;
/**
 ...
 */
export declare function renderUserProfileMarkdown(profile: UserProfile): string;
