 ...
 */
function deriveIterationReason(iterationResult, hookDecision, hooksExecuted) {
    ...
    if (iterationResult.status === "waiting") {
        ...
        if (kinds.size === 1) {
            ...
            if (kind === "breakpoint")
                return "breakpoint-waiting";
            if (kind === "sleep")
                return "sleep-waiting";
 ...
 */
function deriveHookStatus(hookResult) {
