...
exports.deriveCompletionProof = deriveCompletionProof;
exports.resolveCompletionProof = resolveCompletionProof;
const crypto = __importStar(require("node:crypto"));
const COMPLETION_PROOF_SALT = "babysitter-completion-secret-v1";
function deriveCompletionProof(runId) {
    return crypto.createHash("sha256").update(`${runId}:${COMPLETION_PROOF_SALT}`).digest("hex");
}
function resolveCompletionProof(metadata) {
