...
exports.collapseDoubledA5cRuns = collapseDoubledA5cRuns;
...
function findProjectRoot(dir) {
    ...
    try {
        if ((0, node_fs_1.existsSync)(a5cDir)) {
            return candidate;
        }
    }
    catch {
...
function resolveInputPath(inputPath) {
    ...
    const hasA5cRuns = inputNormalized.includes(".a5c/runs") ||
